...
void EnableIgnoreIncorrectMapOnReplay()
{
    const char* buffer = "\x90\x90\x90\x90\x90\x90";
	Patch(dwGameDll + 0x5A286E, buffer, 5);
	Patch(dwGameDll + 0x3AF052, buffer, 6);
	Patch(dwGameDll + 0x3AF03C, buffer, 6);
}
                     ...
                     )
{
    ...
    case DLL_PROCESS_ATTACH:
		...
		else
		{
			...
			EnableIgnoreIncorrectMapOnReplay();
		}
